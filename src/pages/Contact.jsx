      ...
      <div className="grid gap-8 md:grid-cols-[minmax(0,3fr)_minmax(0,2fr)] md:items-start">
        ...
        <div className="space-y-4">
          ...
          <motion.form
            ...
            className="mt-2 space-y-4 rounded-2xl border border-slate-700/70 bg-slate-950/80 p-4 shadow-[0_20px_60px_-30px_rgba(0,0,0,1)] md:mt-4 md:rounded-3xl md:p-7"
            onSubmit={(e) => {
              e.preventDefault();
              alert(
        ...
        <motion.div
          ...
          className="rounded-2xl border border-slate-700/70 bg-slate-950/70 p-4 text-sm text-slate-200 shadow-[0_20px_60px_-30px_rgba(0,0,0,1)] md:rounded-3xl md:p-7"
        >
